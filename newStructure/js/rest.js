 ...
 */
 ...
 /**
  *  Função que envia dos dados de um formulário via POST.
  *
  * @param {SubmitEvent} evento
  * @param {CallBack} callback - função a ser chamada quando a resposta chegar
  */

async function enviar(evento, callback) {
...
async function enviaFormDataComoJson(url, formData) {
  /* Não se pode passar uma instância de `FormData` diretamente com
     ...
     esse objeto como uma string JSON.
...
/* @see https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Guide/M%C3%B3dulos

export { enviar, remover };
*/
